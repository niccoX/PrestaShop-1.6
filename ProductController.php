        ...
        if (is_array($attributes_groups) && $attributes_groups) {
            ...
            foreach ($attributes_groups as $k => $row) {
                ...
                if (!isset($groups[$row['id_attribute_group']])) {
				 ...
				 if((int) $row['quantity'] == 0 || (int) $row['quantity'] < 0 ) $strQty=" - Sold Out"; else $strQty=""; /// Added by Ajay 01-12-2018

                $groups[$row['id_attribute_group']]['attributes'][$row['id_attribute']] = $row['attribute_name'].$strQty;
